...
class Blog_model extends CI_Model {
                ...
                if ( is_numeric( $id ) ) {
                        ...
                        if ( $result -> num_rows() > 0 ) {
                                ...
                                if(!empty($topic_associated)){
                                    $data[ 'topic_associated' ] = $topic_associated;
                                }else{
                                    $data[ 'topic_associated' ] = array();
                                }
        ...
        function changeActiveStatus( $id, $newstatus, $type ) {
                ...
                $this -> db -> where( 'id', $id );
                $this -> db -> update( $table_name, array ( 'is_active' => $newstatus ) );
                if ( $newstatus == 0 ) {
                        return FALSE;
                } else {
                        return TRUE;
