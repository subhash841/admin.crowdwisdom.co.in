                ...
                <?php if ( ! empty( $Blog_detail ) ) { ?>
                        ...
                        <div class="row" style="padding: 20px 0;">
                            ...
                            <?php if ( $Blog_detail[ 'image' ] != "default_blog.png" ) { ?>
                                    <div style="text-align: center;"><img style="max-width: 100%;width:550px;" src="<?php echo base_url( "images/blogs/" . $Blog_detail[ 'image' ] ); ?>" alt="Crowd Forecast"></div>
                            <?php } ?>
                            <div class="blogtext">
