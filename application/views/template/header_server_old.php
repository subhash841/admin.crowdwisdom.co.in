            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Stock')) ? "active" : "" ?>">
                            <a href="javascript:void(0);" class="menu-toggle <?php echo (strpos($_SERVER['PHP_SELF'], 'toggled')) ? "active" : "" ?>">
                                <i class="material-icons">show_chart</i>
                                <span>Stocks</span>
                            </a>
                            <ul class="ml-menu">
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Stock/stock_list')) ? "active" : "" ?>">
                                    <a href="<?= base_url() ?>Stock/stock_list" class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Stock/stock_list')) ? "active" : "" ?>">
                                        Stock List
                                    </a>
                                </li>
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Stock/period')) ? "active" : "" ?>">
                                    <a href="<?= base_url() ?>Stock/period" class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Stock/period')) ? "active" : "" ?>">
                                        Stocks & Period
                                    </a>
                                </li>
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Stock/define_experts')) ? "active" : "" ?>">
                                    <a href="<?= base_url() ?>Stock/define_experts" class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Stock/define_experts')) ? "active" : "" ?>">
                                        Define Expert
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Election')) ? "active" : "" ?>">
                            <a href="javascript:void(0);">
                                <i class="material-icons">&#xE913;</i>
                                <span>Elections</span>
                            </a>
                            <!--<ul class="ml-menu">
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], '')) ? "active" : "" ?>">
                                    <a href="<?= base_url() ?>" class="<?php echo (strpos($_SERVER['PHP_SELF'], '')) ? "active" : "" ?>">
                                        Stock List
                                    </a>
                                </li>
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], '')) ? "active" : "" ?>">
                        ...
                        <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Blogs')) ? "active" : "" ?>">
                            <a href="javascript:void(0)" class="menu-toggle">
                                <i class="material-icons">&#xE913;</i>
                                <span>Blogs</span>
                            </a>
                            <ul class="ml-menu">
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Blogs/category')) ? "active" : "" ?>">
                                    <a href="<?= base_url() ?>Blogs/category">Category</a>
                                </li>
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Blogs/subcategory')) ? "active" : "" ?>">
                                    <a href="<?= base_url() ?>Blogs/subcategory">Sub Category</a>
                                </li>
                                <li class="<?php echo (strpos($_SERVER['PHP_SELF'], 'Blogs/index')) ? "active" : "" ?>">
