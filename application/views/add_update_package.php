                        ...
                        <form name="addUpdatePackage" id="addUpdatePackage" method="POST" action="<?= base_url() ?>Packages/create_update">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    ?>>
                                    <label for="radio_type_premium">Premium</label>
                                ...
                                ?>>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="package_price" id="package_price" required="" maxlength="10" value="<?= @$price ?>" aria-required="true" placeholder="Price">
                                            <!--<label class="form-label">Price</label>-->
                                        </div>
                                    </div>
                                </div>
