        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <?php
                        $surveyid = $this -> input -> get( 'id' ) != "0" ? $this -> input -> get( 'id' ) : "0";
                        $end_date = (@$end_date == "") ? "" : date( "d-m-Y", strtotime( @$end_date ) );
                        ?>
                        <form name="addUpdateSurvey" id="addUpdateSurvey" method="POST" autocomplete="off">
                            <!--action="base_url()Survey/create_update"-->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="survey_title" id="survey_title" required="" maxlength="75" value="<?= @$question ?>" aria-required="true">
                                            <label class="form-label">Ask a Question</label>
                                        </div>
                                    </div>
                                    <!--                                    <div class="form-group form-float">
                                                                            <div class="form-line">
                                                                                <select class="form-control" name="survey_category" id="survey_category" required>
                                                                                    <option value="">-- Select Category --</option>
                                    <?php
                                    foreach ( $survey_category as $key => $pc ):
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line form-float">
                                            <textarea rows="4" class="form-control no-resize" name="survey_desc" required="required" maxlength="300" placeholder="Question Description"><?= @$description ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line form-float">
                                            <textarea rows="4" class="form-control no-resize" name="survey_meta_keywords" required="required" placeholder="Meta Keywords"><?= @$meta_keywords ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line form-float">
                                            <textarea rows="4" class="form-control no-resize" name="survey_meta_description" required="required" placeholder="Meta Description"><?= @$meta_description ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row add-more-choices">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="choice[]" id="choice1" required="" maxlength="35" placeholder="Enter Choice" value="<?= @$choices[ 0 ][ 'choice' ] ?>" aria-required="true">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="choice[]" id="choice2" required="" maxlength="35" placeholder="Enter Choice" value="<?= @$choices[ 1 ][ 'choice' ] ?>" aria-required="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="row" style="text-align: right;">
                                        <div class="col-sm-12">
                                            <button type="button" class="btn btn-approve waves-effect add-survey-choices">Add Choices</button>
                                        </div>
                                    </div>      
                                </div>
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <input name="survey_choice" type="radio" id="radio_type_single" class="with-gap radio-col-red" required="" value="0" <?php
                                            if ( @$is_multiple == 0 ) {
                                                    echo 'checked=""';
                                            }
                                            ?>>
                                            <label for="radio_type_single">Single Choice</label>
                                        </div>
                                        <div class="col-sm-3">
                                            <input name="survey_choice" type="radio" id="radio_type_multiple" class="with-gap radio-col-red" required="" value="1" <?php
                                            if ( @$is_multiple == 1 ) {
                                                    echo 'checked=""';
                                            }
                                            ?>>
                                            <label for="radio_type_multiple">Multiple Choice</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
        $(function () {
            ...
            //Condition to display remove surveys
            if (i > 3) {
                $('.add-more-choices div:nth-child(1), .add-more-choices div:nth-child(2)').find('.remove-survey-choices').removeClass('display-delete');
            }
            //Add new Choices
...
//            }
            ...
            $(document).ready(function () {
                ...
                $("form#addUpdateSurvey").on("submit", function (e) {
                    e.preventDefault();
                    ...
                    ajax_call("/Survey/create_update", "POST", data, function (result) {
                        //result = JSON.parse(result);
                        //alert(result);
                        //if (result.status) {
                        window.location.assign("<?php echo base_url(); ?>Survey/lists");
                        //} else {
                        //result.data.title;
