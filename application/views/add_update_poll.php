                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form name="addUpdatePoll" id="addUpdatePoll" method="POST" autocomplete="off">
                            ...
                            <input type="hidden" name="json_data" id="json_data" value='<?= @$data ?>' />
                            <div class="row">
                                <div class="col-sm-12">
...
//      
        ...
        $(document).ready(function () {
            ...
            $('#search_topics').on('keyup', function () {
                ...
                var topic = $(this).val();
                // console.log(selectedTopicId.length);
                if(selectedTopicId.length >= 1){
                    $('.searched_topics').hide();
                }else if (topic && topic.length >= 2) {
                    $('.searched_topics').html('');
                    //alert(data);
                    $.ajax({
                        url: base_url+"/Poll/fetchdata",
                        method: "POST",
            ...
            $("form#addUpdatePoll").on("submit", function (e) {
                ...
                var url_D=base_url+"/Poll/create_update";
                ajax_call(url_D, "POST", data, function (result) {
